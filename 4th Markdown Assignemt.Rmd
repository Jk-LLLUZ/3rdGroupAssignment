...
Summation of $x_i$ times $y_i$
  ...
  $$
  $$
    \sum_{i = 1}^{20} =8385.202\approx8385.20
  $$
...
[Enter linear regression formula]
...
## dur   = duration
## EPws  = Electrical Power with sensors
## EPwos = Electrical Power without sensors
## ER    = Energy Reduction

dur   = c(1,7,14,21,28,35,42,49,56,63,70,77,84)
EPws  = c(0.504,2.711,5.058,7.158,8.890,10.622,12.264,13.816,15.278,16.651,17.933,19.126,20.229)
EPwos = c(0.664,4.648,9.296,13.944,18.592,23.24,27.888,32.536,37.184,41.832,46.48,51.128,55.776)
ER    =  1 - EPws/EPwos

data1 = data.frame(dur,EPws,EPwos)


knitr::kable(data1, "pipe", col.names = c("Duration","With Sensors","Without Sensors"), align = c("c", "c", "c"))




data2 <- lm(dur ~ EPws + EPwos)
