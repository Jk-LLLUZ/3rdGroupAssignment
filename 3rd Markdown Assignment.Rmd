...
Given this timely issue, solutions should be explored and implemented surrounding concepts of energy reduction and cost efficiency.  With that, the researchers came across an Indonesian academic article written by (authors) which tackles a simple yet impactful solution to  reducing the cost of electrical bills.  Using fundamental concepts of electronics and programming, the researchers were able to test automatic light switches (sensor-based) against manual, traditional light switches in public restrooms as these are places wherein light is left on for long periods of time - therefore implying larger energy consumption and cost.
