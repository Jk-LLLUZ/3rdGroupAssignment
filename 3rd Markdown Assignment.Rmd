...
T_ws <- data.frame(  
                    ...
                    Energy_Reduction=c(24.10,41.67,45.59,48.66,52.18,54.29,56.02,57.54,58.91,60.20,61.42,62.59,63.73)
                  )
...
knitr::kable(test3, caption = '**Percentage of Reduction over time**' ) 
